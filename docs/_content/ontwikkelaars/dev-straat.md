...
inzichtelijk gemaakt op Swagger.io. Zie de [spec documentatie]({{ "api-specificaties.md" | relative_url}}).
...
referentie-implementatie stack op te brengen. Zie de [developer documentatie]({{ "aan-de-slag.md" | relative_url }}).

---
title: " Specificatie van gedrag Zaken API"
weight: 10
layout: page-with-side-nav
---

# Specificatie van gedrag Zaken API
...
- `zaakverzoek` - relatie naar een zaak verzoek
- `zaakcontactmoment` - relatie naar een zaak contactmoment

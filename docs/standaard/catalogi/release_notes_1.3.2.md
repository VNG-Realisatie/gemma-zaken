...
Sinds de release van de vorige versie van de Catalogi API is er veel onduidelijkheid over het historiemodel. In deze versie is een [Primer document](https://github.com/VNG-Realisatie/gemma-zaken/blob/master/docs/standaard/catalogi/historie_model/historie_model.md) toegevoegd waarin het historiemodel wordt uitgelegd aan de hand van diagrammen met voorbeeldberichten. 

...
- [ ] Product Owner akkoord (vinkje mag alleen door Eelco worden gezet)
...
- [ ] **_Userstory is voorzien van veldmapping naar RGBZ2_** (vinkje mag alleen door Arjan worden gezet)
- [ ] **_Userstory past op wenselijk gebruik ZGW volgens GEMMA 2_** (vinkje mag alleen door Jeffrey worden gezet)
...
- [ ] de gewenste (aanvulling op de) functionaliteit (van de API's) is geanalyseerd en beschreven.
